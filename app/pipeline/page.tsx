      ...
      <main className="p-5 max-w-[1800px] mx-auto">
        {jobs.length === 0 ? (
          <div className="text-center py-24">
            <p className="text-text-secondary text-sm">No jobs in your pipeline yet.</p>
            <p className="text-text-muted text-xs mt-1">
              Run <code className="text-accent bg-accent/5 px-1.5 py-0.5 rounded text-[0.7rem]">talentclaw search</code> to discover opportunities.
            </p>
          </div>
        ) : (
